...
public class Dijkstra {
    private String TAG = "dijkstraTAG";
    DatabaseHelper dbHelper;
    Cursor cursor;

    String[][] graph = new String[1000][1000];
    public String jalur_terpendek1 = "";
    public String status = "none";

    public void jalurTerpendek(String[][] arg_graph, int simpulAwal, int simpulTujuan){

        System.out.println("jalurTerpendeks : " + simpulAwal + " & st : " + simpulTujuan);
        if(simpulAwal == simpulTujuan){
            Log.d(  "jalurTerpendek: ","die");
            status = "die";
            return;
            //System.exit(0);
        }
        ...
        if(simpul_maju != simpul_tujuan){
            ...
            for(int perulangan = 0; perulangan < 1; perulangan++){
                ...
                //Nilai * yg ditandai
                if (perbandinganSemuaBobot.size()==0){
                    return;
                }
...
//                    Log.i(  "jalurTerpendek: ", i.getMessage());
//                }
            ...
            Log.d(TAG, "jalurTerpendek: "+jalur_terpendek);
        }//end if start != finish
